 ...
 ******************************************************************************/
    ...
    public class WrongBTree<Key extends Comparable<Key>, Value>
    {
        ...
        private static final class Node
        {
            ...
            private Entry[] entries = new Entry[edu.yu.cs.com1320.project.Impl.WrongBTree.MAX]; // the array of children
            private Node next;
        ...
        private Node put(Node currentNode, Key key, Value val, int height)
        {
            ...
            if (currentNode.entryCount < edu.yu.cs.com1320.project.Impl.WrongBTree.MAX)
            {
        ...
        {
            Node newNode = new Node(edu.yu.cs.com1320.project.Impl.WrongBTree.MAX / 2);
            //by changing currentNode.entryCount, we will treat any value
            //at index higher than the new currentNode.entryCount as if
            //it doesn't exist
            currentNode.entryCount = edu.yu.cs.com1320.project.Impl.WrongBTree.MAX / 2;
            //copy top half of h into t
            for (int j = 0; j < edu.yu.cs.com1320.project.Impl.WrongBTree.MAX / 2; j++)
            {
                newNode.entries[j] = currentNode.entries[edu.yu.cs.com1320.project.Impl.WrongBTree.MAX / 2 + j];
            }
            //external node
            if (height == 0)
            {
        ...
        {
            edu.yu.cs.com1320.project.Impl.WrongBTree<Integer, String> st = new edu.yu.cs.com1320.project.Impl.WrongBTree<Integer, String>();
            st.put(1, "one");
            st.put(2, "two");
            st.put(3, "three");
            st.put(4, "four");
